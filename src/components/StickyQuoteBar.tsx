...
const DISMISSED_KEY = "_yinrui_quotebar_dismissed";
...
export default function StickyQuoteBar() {
  ...
  const waUrl = buildWhatsAppUrl(
    "Hi, I'd like to learn more about the CarryOn PCR platform."
  );

  return (
    <div className="fixed bottom-0 left-0 right-0 z-40 hidden md:block">
      <div className="bg-[var(--color-primary)] text-white shadow-2xl border-t border-white/10">
        <div className="mx-auto max-w-7xl px-6 py-3 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <a
              href="/en/contact/"
              className="inline-flex items-center gap-2 rounded-lg bg-[var(--color-accent)] px-4 py-2 text-sm font-semibold text-white hover:bg-[var(--color-accent-light)] transition-colors"
            >
              Request Demo
            </a>
